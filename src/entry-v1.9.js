...
async function collect(env,source){
  ...
  let fetchError=null;
  try{
    const response=await fetch(WORKFLOW_RUNS_URL,{headers:{accept:'application/vnd.github+json','user-agent':'CuratorOps-BrowserJourney/1.9 (+https://ops.oceanlinercurator.com)','x-github-api-version':'2022-11-28'}});
